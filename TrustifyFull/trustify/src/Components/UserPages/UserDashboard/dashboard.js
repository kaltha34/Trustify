...
const Dashboard = () => {
  ...
  // Runs once on mount to get the userEmail

  useEffect(() => {
    if (!userEmail) return;

    fetch(
      `http://localhost:5000/api/notifications/dashboard?userEmail=${userEmail}`
    )
        ...
        <div className="Verifications">
          <div className="Verification-content">
            ...
            <p className="verification-description">
              You'll see whether your activities are active, pending, or
              blocked, helping you stay on top of your account status.
            </p>
