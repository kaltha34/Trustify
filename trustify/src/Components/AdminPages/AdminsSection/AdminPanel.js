    ...
    <div className={`admin-panel ${isLightMode ? "light-mode" : "dark-mode"}`}>
      ...
      <div className="grid-container">
        ...
        <div className="grid-item container3">
          ...
          <p>
            <strong>Email:</strong> mark.johnson@example.com
          </p>
          <p>
            <strong>ID:</strong> 003
          </p>
        </div>
        <div className="grid-item container4">
          ...
          />
          <p>
            <strong>Name:</strong> Emma Brown
          </p>
          <p>
            <strong>Email:</strong> emma.brown@example.com
          </p>
          <p>
            <strong>ID:</strong> 004
          </p>
        </div>
        <div className="grid-item container5">
          ...
          />
          <p>
            <strong>Name:</strong> Lucas White
          </p>
          <p>
            <strong>Email:</strong> lucas.white@example.com
          </p>
          <p>
            <strong>ID:</strong> 005
          </p>
        </div>
        <div className="grid-item container6">
          ...
          />
          <p>
            <strong>Name:</strong> Olivia Green
          </p>
          <p>
            <strong>Email:</strong> olivia.green@example.com
          </p>
          <p>
            <strong>ID:</strong> 006
          </p>
        </div>
      </div>
    </div>
